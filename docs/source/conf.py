...
project = 'IP2WHOIS D SDK'
copyright = '2024, IP2Whois'
author = 'IP2Whois'
...
myst_html_meta = {
    "description": "D SDK enables user to easily implement the checking of WHOIS information for a particular domain into their solution using the API from www.ip2whois.com.",
    "keywords": "IP2WHOIS, D, WHOIS, domain",
...
html_title = "IP2WHOIS D SDK"

# html_baseurl = "https://ip2whois-d.readthedocs.io/en/latest/"